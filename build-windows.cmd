...
electron-packager build Squiffy --platform=win32 --arch=ia32 --version=0.29.2 --app-bundle-id=uk.co.textadventures.squiffy --icon=squiffy.ico --app-version=4.0.0 --ignore=Output --version-string.ProductName=Squiffy --version-string.FileDescription=Squiffy --version-string.LegalCopyright="Copyright (c) 2015 Alex Warren" --version-string.OriginalFilename=Squiffy.exe --version-string.FileVersion=4.0.0 --version-string.ProductVersion=4.0.0 --version-string.InternalName=Squiffy --version-string.CompanyName="Alex Warren"