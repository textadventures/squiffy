...
squiffy.story.sections = {
	'_default': {
		'text': "<p>Looking around the room, you can see a <a class=\"squiffy-link\" data-passage=\"TV\">TV</a>, a <a class=\"squiffy-link\" data-passage=\"book\">book</a> and a piece of <a class=\"squiffy-link\" data-passage=\"paper\">paper</a> with some handwriting scribbled on it.</p>",
		'passages': {
			'TV': {
				'text': "<p>Covered in dust and the plug is missing.</p>",
			},
			'book': {
				'text': "<p>It&#39;s a book of magic tricks. Maybe you should <a class=\"squiffy-link\" data-passage=\"open\">open</a> it?</p>",
			},
			'open': {
