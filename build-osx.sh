...
electron-packager ./build Squiffy --platform=darwin --arch=x64 --version=0.33.2 --app-bundle-id=uk.co.textadventures.squiffy --helper-bundle-id=uk.co.textadventures.squiffy.helper --icon=squiffy.icns --app-version=4.0.0
